...
task_pomodoros = ttk.Spinbox(create_task_bar, from_=1, to=VISIBLE_POMODOROS, width=2, textvariable=default_pomodoros)
add_task = ttk.Button(
    create_task_bar,
    text="Add task",
...
start = ttk.Button(
    button_bar, text="Start", width=10, command=lambda: start_pomodoro(25 * 60, tasks_frame)
)
break_ = ttk.Button(
...
stop = ttk.Button(button_bar, text="Stop", width=10, command=lambda: stop_pomodoro(tasks_frame))
